...
// OAuth consent page for MCP integrations and external clients.
export default function OAuthConsent() {
    ...
    const clientName = (info && info.client_name) || "An AI client";
    ...
    if (decided) {
        return (
            <AuthLayout
                ...
                subtitle={`You can return to ${clientName} and close this window.`}
            />
        );
    }
    ...
    return (
        <AuthLayout
            ...
            subtitle={`${clientName} wants to access ${appName} on your behalf`}
        >
            {error && (
